...
class HomeWindow:
    ...
    def _add_menubar(self):
        ...
        edit.add_separator()
        edit.add_cascade(label='Colorization Params', menu=colorization_params)
        ...
        view.add_command(label='Halting Filter Intensity', command=view_halting_filter_intensity_command)
        view.add_separator()
